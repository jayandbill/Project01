...
public class ReportConfig {
    ...
    public static enum ReportMode {ExpandedToSimplified, SimplifiedToExpanded};
    public static enum WhatToPrint {exercisesOnly, ExercisesWithSolutions, BothCopies};
    private int totalProblems;
    //private boolean printSolutions;
    private WhatToPrint whatToPrint;
    private String fileNameAndPath;     // c:\temp\test.html, etc.
