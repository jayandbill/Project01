 ...
 * TestForm.java
 *
 * Created on Mar 22, 2009, 10:11:26 PM
 */
...
public class TestForm extends javax.swing.JFrame {
    ...
    private void generatePolymonialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generatePolymonialActionPerformed
    ...
    }//GEN-LAST:event_generatePolymonialActionPerformed

    private void polynomialLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_polynomialLabelMouseClicked
        String str;
//      This is a tricky way to get a breakpoint when we need it.
//      This code should only be run when we have already generated a polynomial and
//       we want to see how it gets simplified.
//      str = p.toString();
//      polynomialLabel.setText(str);
        str = pTmp.Simplify().toString();
        simplfiedPolynomialLabel.setText(str);
    }//GEN-LAST:event_polynomialLabelMouseClicked
